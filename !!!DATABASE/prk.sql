...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2016 at 04:14 PM
...
(12, 4, 'Active'),
(13, 10, 'Completed'),
(14, 3, 'Waiting for Approval'),
(15, 3, 'Waiting for Approval'),
(16, 3, 'Waiting for Approval'),
(17, 3, 'Waiting for Approval');
...
('PR001', 2, 'Up', 5),
('PR017', 10, 'Tas nya bagus, kedap air dan terlihat awet :D', 5),
('PR017', 5, 'Saya tertarik namun sayang tidak ada warna lain selain warna hitam', 2),
('PR017', 12, 'Cool !', 3);
...
('PR001', 'Mouse Razer', 1250000, 3, 82, 'mouse.png', 'Goldwin Japar'),
('PR002', 'Keyboard Razer Blue', 2551000, 1, 69, 'keyboard.png', 'Goldwin Japar'),
('PR003', 'Baju Biru', 150000, 1, 34, 'baju.jpg', 'Goldwin Japar'),
('PR004', 'Celana', 145500, 2, 60, 'celana.jpg', 'Goldwin Japar'),
('PR005', 'Monitor', 1900000, 10, 17, 'monitor.jpg', 'Goldwin Japar'),
...
('PR012', 'Eye Protector', 100500, 1, 661, 'kacamata.png', 'Goldwin Japar'),
...
('PR021', 'Sepatu Bola', 555000, 2, 977, 'sepatubola.jpg', 'Goldwin Japar');
